...
const analysis = {
  ...
  manual_test_calls: 1,
  full_suite_test_calls: 1,
  manual_build_calls: 1,
  test_reinspection_calls: 0,
  same_generation_test_reruns: 0,
  same_generation_full_suite_reruns: 0,
  same_generation_partial_suite_reruns: 0,
  first_failure_tool_output_chars: null,
  next_call_input_tokens_after_failure: null,
  post_failure_input_tokens: 0,
  post_failure_cache_read_tokens: 0,
  post_green_verification_calls: 0,
  multiple_element_failures_total: 0,
  rtl_dom_leak_failures: 0,
  query_ambiguity_failures: 0,
  multiple_element_failure_excerpts: [],
  harness_green_but_no_first_green: false,
