...
export function CohortActionFlow({ runs, labels }: Props) {
  ...
  if (chartRuns.length < 2) {
    return (
      <p className="muted">
        Need at least two v2 runs with action_flow in this cohort to compare side-by-side.
      </p>
    );
  }
  ...
  return (
    <div className="cohort-flow stack">
      <div className="ruler-tabs" role="tablist" aria-label="Cohort ruler">
